...
Simulation of Intraocular Fluid Dynamics}}\\
...
\only<2>{
\ALERT{Comparing model results with clinical studies (statistics).}


\ALERT{Perspectives}
\begin{itemize}
\item Coupling with a mathematical model of retinal blood flow.
\item Inclusion of oscillations in choroidal blood volume (posterior chamber $\leftrightarrow$ oscillation in IOP).
