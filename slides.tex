...
\begin{frame}{IOP}
-IOP (physiologicals values)\\
-Function (inflates the globe of the eye)\\
-measure (tonometry)\\
=== risk:elevated IOP
\end{frame}
...
-Definition\\
-morphological and physiological damage (figure *2)\\
-link between IOP and glaucoma\\

\end{frame}

\begin{frame}{Treatment}
-List of medication and effect (table)\\
-vary based on unknown factors\\
\end{frame}
